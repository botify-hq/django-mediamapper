...
setup(
    ...
    dependency_links = ['git://github.com/sem-io/facebook-sdk-fork#egg=facebook', 'git://github.com/twidi/django-extended-choices.git#egg=extended_choices', 'git://github.com/dkm/python-vimeo.git#egg=vimeo'],
