...
setup(
    ...
    dependency_links = ['http://github.com/sem-io/facebook-sdk-fork#egg=facebook', 'http://github.com/twidi/django-extended-choices.git#egg=extended_choices', 'git://github.com/dkm/python-vimeo.git#egg=vimeo'],
