...
setup(
    ...
    dependency_links = ['https://github.com/sem-io/facebook-sdk-fork#facebook_sdk', 'http://github.com/twidi/django-extended-choices.git#egg=extended_choices', 'git://github.com/dkm/python-vimeo.git#egg=vimeo'],
